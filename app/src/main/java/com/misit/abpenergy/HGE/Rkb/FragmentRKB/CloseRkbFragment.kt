 ...
 */
class CloseRkbFragment : Fragment(), UserRkbListAdapter.OnItemClickListener , RefreshDataTotal {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_close_rkb, container, false)
