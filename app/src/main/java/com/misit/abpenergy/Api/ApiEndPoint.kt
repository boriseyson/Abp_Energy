...
import com.misit.abpenergy.HGE.Rkb.Response.*
import com.misit.abpenergy.HSE.Inspeksi.Response.*
import com.misit.abpenergy.HSE.HazardReport.Response.*
...
import com.misit.abpenergy.ENP.Monitoring_Produksi.Response.StockResponse
...
import com.misit.abpenergy.HGE.Sarpras.SaranaResponse.IzinKeluarSaranaResponse
import com.misit.abpenergy.HGE.Sarpras.SarprasResponse.KaryawanResponse
...
interface ApiEndPoint{
    ...
    @GET("/android/api/hse/item/hazard/report")
    suspend fun getItemHazardCorotine(@Query("uid") uid:String)
            : Response<DetailHazardResponse>?
